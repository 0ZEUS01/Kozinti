...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.addRecipe.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, addNewRecipe.class)));

        binding.profileIcon.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, Profile.class)));
